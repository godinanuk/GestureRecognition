...
2. MobileNet V2 - results - best validation accuracy 77% - best train accuracy 73% - epochs -> 30 with earlystopping - trainable parameters 33,296,389 -> image size 160x160x3
