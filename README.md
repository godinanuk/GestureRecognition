...
1. Inception V3 - results - best validation accuracy 80% - best train accuracy 90% - epochs -> 30 with earlystopping - trainable parameters 19,402,757 -> image size 160x160x3
